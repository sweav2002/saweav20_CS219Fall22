...
public class Zipcode implements Comparable<Zipcode>, Distance {
    ...
    public WeatherObservation getWeatherData() {
        ...
        String path = "http://api.geonames.org/findNearByWeatherJSON?formatted=true&lat=" + this.lat + "&lng=" + this.lng +
                "&username=edharcourt\n";

        try {
            url = new URL("http://api.geonames.org/findNearByWeatherJSON?formatted=true&lat=44&lng=-74&username=edharcourt"); // create a URL object for the path
